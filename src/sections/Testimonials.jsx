...
const testimonials = [
  {
    quote:
      "Abraham is one of the most talented engineers I know. His attention to detail and ability to translate complex requirements into elegant solutions is remarkable.",
    author: "Christian Maurice",
