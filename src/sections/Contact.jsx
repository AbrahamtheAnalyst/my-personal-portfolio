...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "abrahamjohnmaurice7@gmail.com",
    href: "mailto:abrahamjohnmaurice7@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+234 810 293 8620",
    href: "tel:+2348102938620",
  },
  {
    icon: MapPin,
    label: "Location",
      ...
      <div className="container mx-auto px-4 relative z-10 w-full max-w-full">
        ...
        <div className="w-full px-0 grid lg:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all box-border"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-surface rounded-xl border border-border focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none box-border"
                />
              </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400 w-full min-w-0">
            ...
            {/* Availability Card: Added p-5 sm:p-8 */}
            <div className="glass rounded-3xl p-5 sm:p-8 border border-primary/30 w-full">
